...
## GIT
##==============================================================================
git_symbol_synced="\[$(tput setaf 2)\]"' '
git_symbol_unpushed="\[$(tput setaf 3)\]"' ▲'
git_symbol_unpulled="\[$(tput setaf 3)\]"' ▼'
git_symbol_unpushedunpulled="\[$(tput setaf 1)\]"' ◆'
git_symbol_dirty="\[$(tput blink setaf 1)\]"' '
git_symbol_dirty_unpushed=$git_symbol_unpushed$git_symbol_dirty
git_symbol_dirty_unpulled=$git_symbol_unpulled$git_symbol_dirty
git_symbol_dirty_unpushedunpulled=$git_symbol_unpushedunpulled$git_symbol_dirty
...
##==============================================================================
	...
	PROMPT_COMMAND="conda_auto_env;prompt_command_hook"
}
